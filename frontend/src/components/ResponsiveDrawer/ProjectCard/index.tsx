import { Card, CardContent, CardMedia, Typography, Link, Chip, List, Box, useTheme } from "@mui/material";
        ...
        <Box sx={{ display: "flex", justifyContent: "space-around", marginBottom: 1 }}>
          <Typography variant="body2">
            <Link href={project.deployUrl} target="_blank" rel="noopener" sx={{ display: "flex", alignItems: "center", columnGap: 0.5 }}>
              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke={theme.palette.primary.main} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-github">
          ...
          <Typography variant="body2">
            <Link href={project.sourceCodeUrl} target="_blank" rel="noopener" sx={{ display: "flex", alignItems: "center", columnGap: 0.5 }}>
              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke={theme.palette.primary.main} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-external-link">
                <path d="M15 3h6v6" />
                <path d="M10 14 21 3" />
